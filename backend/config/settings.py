...
ALLOWED_HOSTS = config("ALLOWED_HOSTS", default="diplom.robiyaxon.uz,localhost,127.0.0.1", cast=Csv())
...
CORS_ALLOWED_ORIGINS = config(
    "ALLOWED_ORIGINS",
    default="https://diplom.robiyaxon.uz,http://localhost:3000,http://localhost:3001,http://localhost:3004",
    cast=Csv(),
)
